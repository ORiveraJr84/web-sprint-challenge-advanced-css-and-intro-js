...
console.log("This is the answer to task 1A -- first artist's name ---> " + artists[0].name);
console.log("This is the answer to task 1B -- the third artist's bio ---> " + artists[2].bio);

/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */

artists[8].name = "Vincent Van Gogh";
console.log("This is the answer to task 2 -- the 9th artist's corrected name ---> " + artists[8].name);
...
function getArtistByIndex(array, index) {
    console.log (`This is the answer to task 3 ---> The artist at index ${index} is ${array[index].name}.`);
  }
...
function removeArtist(array,index) {
  ...
  console.log("This is the answer to task 5 ---> " , array);
}
...
function addArtist(id, name, years, genre, nationality, bio){
  ...
  console.log("This is the answer to task 6 ---> ", artists);
}

addArtist(20, "Orlando Rivera, Jr.", "1984 - present", "Web Design", "Puerto Rican","Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque placerat, dui ut tempor condimentum, mi neque sollicitudin leo, interdum dictum dui dui fringilla ante. Mauris vel placerat metus. Etiam rhoncus fringilla ultrices. Pellentesque eleifend massa eu dolor porta, vel cursus diam lacinia. Nam vel lectus elit. Maecenas eleifend mi eu nisi luctus mattis. Nunc vel sem imperdiet, imperdiet sem sed, ornare risus.");
...
function lotsOfArt(arr){
  ...
  console.log("This is the answer to task 7 ---> ", filteredArr);
}
